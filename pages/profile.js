...
const Profile = () => {
    return (
        <div className="bg-gray-100 flex flex-col items-center justify-center">
            ...
            <main className="flex flex-col items-start gap-16 w-full h-full px-14 py-8">
                ...
                <form className="flex flex-col items-start gap-8 w-full" action="/send-data-here" method="post">
                    <div className="flex flex-row flex-wrap items-start gap-x-40 gap-y-8 w-full">
                        <div className="flex flex-col flex-grow basis-80 items-start gap-3 w-full">
                            <h2 className="text-2xl font-semibold"> General </h2>
                            <div className="flex flex-row items-center justify-between w-full">
                                <label className="font-medium text-gray-900" for="name"> Full name </label>
                                <input className="appearance-none border-2 border-gray-500 text-gray-500 font-medium rounded-full bg-transparent w-2/3 px-4 py-2 focus:text-gray-900" type="text" id="name" name="name" />                        </div>
                            <div className="flex flex-row items-center justify-between w-full">
                        ...
                        <div className="flex flex-col flex-grow basis-80 items-start gap-3 w-full min-w-min">
                            <h2 className="text-2xl font-semibold"> General </h2>
                            <div className="flex flex-row items-center justify-between w-full">
                                <label className="font-medium text-gray-900" for="name"> Full name </label>
                                <input className="appearance-none border-2 border-gray-500 text-gray-500 font-medium rounded-full bg-transparent w-2/3 px-4 py-2 focus:text-gray-900" type="text" id="name" name="name" />                        </div>
