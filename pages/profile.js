        ...
        return (
            <Layout>
                ...
                <div className="flex items-center justify-center w-full">
                    <svg role="status" class="inline w-10 h-10 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-indigo-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
